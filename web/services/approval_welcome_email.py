...
def send_account_approved_welcome(user: dict | None) -> None:
    ...
    site_name = (os.environ.get("SITE_NAME") or "TAKNET-PS AIS Aggregator").strip()
    ...
    <tr><td align="center">
      <table role="presentation" width="100%" style="max-width:560px;background:#ffffff;border-radius:8px;border:1px solid #e5e7eb;overflow:hidden;">
        <tr><td style="padding:24px 28px 8px 28px;">
          <h1 style="margin:0 0 12px 0;font-size:20px;color:#0f172a;">Welcome to TAKNET-PS AIS</h1>
          ...
          <p style="margin:0 0 16px 0;"><strong>TAKNET-PS AIS Aggregator</strong> — distributed AIS vessel tracking for public safety and maritime awareness.</p>
...
"""
    ...
    text_body = (
        ...
        f"TAKNET-PS AIS Aggregator — distributed AIS vessel tracking.\n\n"
        f"Log in: {login_url}\n"
    )
